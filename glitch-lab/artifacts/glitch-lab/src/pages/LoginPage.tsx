    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-6">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[400px] h-[400px] rounded-full"
          style={{ background: "#00ff88", opacity: 0.05, filter: "blur(100px)" }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="border border-[#1a1a1a] bg-[#030303] p-8">
          <div className="font-mono-tech text-[8px] tracking-[4px] text-[#00ff88]/60 mb-6">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-black border border-[#1a1a1a] px-4 py-3 text-white font-mono-tech text-[12px] tracking-[1px] placeholder-[#2a2a2a] focus:outline-none focus:border-[#00ff88]/50 transition-colors"
              />
            </div>
        ...
        <div className="text-center mt-6 font-mono-tech text-[9px] tracking-[3px] text-[#333]">
          NO ACCOUNT?{" "}
          <Link href="/auth/signup" className="text-[#00ff88]/60 hover:text-[#00ff88] transition-colors">
            REGISTER
          </Link>
        </div>
      </div>
